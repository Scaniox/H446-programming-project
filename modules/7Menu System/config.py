...
class Config():
    def __init__(self):
        ...
        self.img_pathX = (Path(__file__).parent / 'img').as_posix()
        self.snd_pathX = (Path(__file__).parent / 'snd').as_posix()
        self.scoreboard_pathX = (Path(__file__).parent /
                               'scoreboard.csv').as_posix()
